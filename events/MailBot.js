  ...
  (module.exports = async (client, message, args) => {
    client.on("channelDelete", channel => {
      if (
        ...
        const person = channel.guild.members.cache.find(
          x => x.id == channel.name
        );
        ...
        let yembed = new discord.MessageEmbed()
          ...
          .setDescription(
            "Your mail is deleted by moderator and if you have any problem with that han you can open mail again by sending message here."
          );
    ...
    client.on("message", async message => {
        ...
        if (command == "setup") {
          if (!message.member.hasPermission("ADMINISTRATOR")) {
            return message.channel.send(
              "You need Admin Permissions to setup the modmail system!"
            );
          }
          ...
          if (
            ...
            const person = message.guild.members.cache.get(
              message.channel.name
            );

            if (!person) {
              return message.channel.send(
                "I am Unable to close the channel and this error is coming because probaly channel name is changed."
              );
            }
          ...
          if (!category) {
            return message.channel.send(
              "Moderation system is not setuped in this server, use " +
                prefix +
                "setup"
            );
          }
          ...
          if (!message.member.roles.cache.find(x => x.name == "SUPPORTER")) {
            return message.channel.send(
              "You need supporter role to use this command"
            );
          }
          ...
          const target = message.guild.members.cache.find(
            x => x.id === args[0]
          );
          ...
          let nembed = new discord.MessageEmbed()
            ...
            .addField(
              "Direct Contact",
              "Yes(it means this mail is opened by a supporter)"
            );
          ...
          let uembed = new discord.MessageEmbed()
            ...
            .setThumbnail(client.user.displayAvatarURL())
            .setDescription(
              "You have been contacted by Supporter of **" +
                message.guild.name +
                "**, Please wait until he send another message to you!"
            );
          ...
          let embed = new discord.MessageEmbed()
            ...
            .setDescription(
              "This bot is made by CTK WARRIOR, You can remove credits :D"
            )
            .addField(
              prefix + "setup",
              "Setup the modmail system(This is not for multiple server.)",
              true
            )

            .addField(
              prefix + "open",
              "Let you open the mail to contact anyone with his ID",
              true
            )
            .setThumbnail(client.user.displayAvatarURL())
            .addField(
              prefix + "close",
              "Close the mail in which you use this command.",
              true
            );
      ...
      if (!message.guild) {
        ...
        const main = guild.channels.cache.find(
        ...
        if (!main) {
          let mx = await guild.channels.create(message.author.id, {
            ...
            parent: category.id,
            topic:
              "This mail is created for helping  **" +
              message.author.tag +
              " **"
          });
          ...
          let sembed = new discord.MessageEmbed()
            ...
            .setThumbnail(client.user.displayAvatarURL())
            .setDescription(
              "Conversation is now started, you will be contacted by supporters soon :D"
            );
          ...
          let eembed = new discord.MessageEmbed()
            ...
            .addField(
              "Direct Contact",
              "No(it means this mail is opened by person not a supporter)"
            );
